...
<script type="text/javascript">
    ...
    function fn_egov_select_noticeListLike(num) {
        document.frm.like.value = 1111; 
        ...
        <!-- //좌측메뉴 끝 -->
            ...
            <div id="content">
                ...
                <form name="frm" method="post" action="<c:url value='/cop/bbs${prefix}/selectBoardList.do'/>">
                    ...
                    <input type="hidden" name="like" value="<c:out value='${searchVO.like}'/>">                   
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                         ...
                         <c:if test="${result.replyPosblAt == 'Y'}">     
                          ...
                          <td width="10"></td>
                          <td>
                              <a href="#LINK" onclick="javascript:fn_egov_select_noticeListLike('1'); return false;">좋아요</a> 
                          </td>
                          <td width="10"></td>
                          <td>
                              <a href="#LINK" onclick="javascript:fn_egov_select_noticeListLike('2'); return false;">싫어요</a> 
                          </td>
                        </tr>
                      </table>
                    </div>
