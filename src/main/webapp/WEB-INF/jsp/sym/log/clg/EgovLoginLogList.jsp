                    ...
                    <div id="search_field_loc"><h2><strong>로그인 로그조회</strong></h2></div>
                        ...
                        <div class="sf_start">
                            ...
                            <ul id="search_second_ul">
                            	...
                            	<li><input name="searchWrd" title="검색어" type="text" size="35" value='<c:out value="${searchVO.searchWrd}"/>'  maxlength="35" onkeypress="press(event);"> </li>
					  			<!--  <li><input type="text" name="searchWrd" id="searchWrd" /></li> -->
					  			<li>
                                <li>
                                    <div class="buttons" style="float:right;">
                                        <a href="<c:url value='/sym/log/clg/SelectLoginLogList.do'/>" onclick="javascript:fn_egov_select_loginLog('1'); return false;" >
                ...
                <div class="default_tablestyle">
                    ...
                    <!-- loop 시작 -->                                
                        <tr>
					        ...
					        <td nowrap="nowrap"><c:out value="${result.loginNm}"/></td>   
                        </tr>
                    </c:forEach>     
                    </tbody>
                    </table>
