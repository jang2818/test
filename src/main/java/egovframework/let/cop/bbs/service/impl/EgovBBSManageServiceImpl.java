...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
	...
	public int selectBoardArticalLikeCnt(BoardVO boardVO){
		return bbsMngDAO.selectBoardArticleLikeCnt(boardVO);
	}
    
	public int selectBoardArticalHateCnt(BoardVO boardVO){
		return bbsMngDAO.selectBoardArticleHateCnt(boardVO);
	}
