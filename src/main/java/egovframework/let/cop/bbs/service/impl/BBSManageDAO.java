...
public class BBSManageDAO extends EgovAbstractDAO {
	...
	public int selectBoardArticleLikeCnt(BoardVO boardVO) {
		// TODO Auto-generated method stub
		return (int)select("BBSManageDAO.selectBoardArticleLikeCnt", boardVO);
	}

	public int selectBoardArticleHateCnt(BoardVO boardVO) {
		// TODO Auto-generated method stub
		return (int)select("BBSManageDAO.selectBoardArticleHateCnt", boardVO);
	}
}
