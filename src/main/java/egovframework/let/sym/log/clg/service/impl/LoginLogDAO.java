...
public class LoginLogDAO extends EgovAbstractDAO {
	...
	public LoginLog selectLoginLog(LoginLog loginLog) throws Exception{
		...
		return (LoginLog) select("LoginLogDAO.selectLoginLog", loginLog);
	}
	...
	public int selectLoginLogInfCnt(LoginLog loginLog) throws Exception{
		...
		return (Integer)select("LoginLogDAO.selectLoginLogInfCnt", loginLog);
	}

	public LoginLog selectLoginLogId(LoginLog loginLog) throws Exception{

		return (LoginLog) select("LoginLogDAO.selectLoginLogId", loginLog);
	}
}
